...
- Click the fetch NFt button and relax to view various NFTs in the collection.
- When you click on a single nft, It shows the details of the nft that's been clicked.
